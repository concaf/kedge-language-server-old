...
exports.KEDGE_SCHEMA_URL = "https://raw.githubusercontent.com/kedgeproject/json-schema/master/master/controllers/deploymentspecmod.json";
...
function configureSchemas(uri, fileMatch, schema, languageSettings) {
    ...
    if (fileMatch.constructor === Array && uri === exports.KEDGE_SCHEMA_URL) {
        fileMatch.forEach((url) => {
            specificValidatorPaths.push(url);
        });
    }
    else if (uri === exports.KEDGE_SCHEMA_URL) {
...
function validateTextDocument(textDocument) {
    ...
    exports.customLanguageService.doValidation(textDocument, yamlDocument, isKedgeFile).then(function (diagnosticResults) {
        let diagnostics = [];
...
connection.onCompletion(textDocumentPosition => {
    ...
    return exports.customLanguageService.doComplete(textDocument, textDocumentPosition.position, jsonDocument, isKedgeFile);
});
...
connection.onHover(textDocumentPositionParams => {
    ...
    return exports.customLanguageService.doHover(document, textDocumentPositionParams.position, jsonDocument, isKedgeFile);
});
